...
public class StorageService {
    ...
    String FOLDER_PATH = System.getProperty("user.dir") + "/file";
    ...
    public boolean deleteImageFromFileSystem(String fileName) throws IOException {
        ...
        if (fileDataOptional.isPresent()) {
            ...
            if (file.exists()) {
                if (file.delete()) {
                    ...
                    throw new IOException("Failed to delete the file from the file system");
                }
            } else {
